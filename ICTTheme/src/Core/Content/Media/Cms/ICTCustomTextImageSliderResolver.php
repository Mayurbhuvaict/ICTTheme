...
#[Package('content')]
class ICTCustomTextImageSliderResolver extends AbstractCmsElementResolver
{
    ...
    {
        return 'ict-custom-text-image-slider';
    }

    public function collect(CmsSlotEntity $slot, ResolverContext $resolverContext): ?CriteriaCollection
    {
        $sliderItemsConfig = $slot->getFieldConfig()->get('sliderItems');
        $coverImage = $slot->getFieldConfig()->get('coverMedia');
